...
const articlesHindi = [
  ...
  },
  {
    ...
    titleURL: "अंकगणित कारक(arithmetic operator)".replace(/\s+/g, "-").toLowerCase(),
    texts: [
      ...
      <Row className='table' fluid>
        <Col className="col-md-2 padding-0 fw-bold" style={{textAlign:"center"}}>
          <h4 style={{color:'black'}}><b>कारक</b></h4>
