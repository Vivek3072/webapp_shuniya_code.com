...
export default function PrivacyPolicy() {
  return (
    <div className="container" div style={{ paddingBottom: "50px" }}>
      ...
      <p>
        [insert website/app name] ("us", "we", or "our") operates the [insert
        website/app URL] website and [insert any other services provided]. This
      ...
      <h3>Use of Data</h3>
      <p>
        [insert website/app name] uses the collected data for various purposes:
      </p>
      <ul>
      ...
      <p>
        [insert website/app name] may disclose your Personal Data in the good
        faith belief that such action is necessary to:
      </p>
      <ul>
        <li>Comply with a legal obligation</li>
        <li>
          Protect and defend the rights or property of [insert website/app name]
        </li>
        <li>
