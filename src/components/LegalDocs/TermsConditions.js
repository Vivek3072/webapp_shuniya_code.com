  ...
  return (
    <div className="container" div style={{ paddingBottom: "50px" }}>
      ...
      <p>
        ...
        carefully before using the [insert website/app URL] website and [insert
        any other services provided] (the "Service") operated by [insert
        website/app name] ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        ...
        it and grant us the rights and license as provided in these Terms, and
      ...
      <p>
        ...
        property of [insert website/app name] and its licensors.
      </p>
      <p>
